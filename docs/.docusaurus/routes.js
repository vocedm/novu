...
export default [
  {
    path: '/markdown-page',
    component: ComponentCreator('/markdown-page', '4ec'),
    exact: true
  },
  {
    path: '/search',
    component: ComponentCreator('/search', '45e'),
    exact: true
  },
  {
    path: '/',
    ...
    routes: [
      ...
      {
        path: '/channels/sms/zenvia',
        component: ComponentCreator('/channels/sms/zenvia', 'ad7'),
        exact: true,
        sidebar: "tutorialSidebar"
      },
      {
